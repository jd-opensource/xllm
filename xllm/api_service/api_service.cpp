...
void ChatCompletionsImpl(std::unique_ptr<Service>& service,
  ...
  auto [preprocess_status, processed_json] =
      PreprocessChatJson(std::move(attachment), is_multimodal);
...
void APIService::ChatCompletionsHttp(
  ...
  if (FLAGS_backend == "llm") {
    ...
    ChatCompletionsImpl<ChatCall, ChatServiceImpl>(chat_service_impl_,
                                                   done_guard,
                                                   ctrl,
                                                   request,
                                                   response,
    ...
    ChatCompletionsImpl<MMChatCall, MMChatServiceImpl>(mm_chat_service_impl_,
                                                       done_guard,
                                                       ctrl,
                                                       request,
                                                       response,
