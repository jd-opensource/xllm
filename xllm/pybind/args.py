...
class ArgumentParser:
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--device_id', type=int, default=0, help='Device id to run the model on, e.g. 0. Defaults to 0.')
        self.parser.add_argument('--devices', type=str, default=None, help='Deprecated. Use --device_id instead. Devices to run the model on, e.g. npu:0,npu:1.')
        self.parser.add_argument('--draft_model', type=str, default='', help='draft hf model path to the model file.')
        self.parser.add_argument('--draft_devices', type=str, default=None, help='Deprecated. If omitted, uses the target model devices when speculative decoding is enabled.')
