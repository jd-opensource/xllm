...
class CausalConv1dDecodeKernel(TilelangKernel):
    ...
    SPECIALIZATIONS = [
        {
            "variant_key": "bs1_d2048_w4_silu1_bf16",
            "batch_size": 1,
            "dim": 2048,
            "width": 4,
            "has_silu": 1,
        ...
        {
            "variant_key": "bs1_d4096_w4_silu1_bf16",
            "batch_size": 1,
            "dim": 4096,
            "width": 4,
            "has_silu": 1,
        ...
        {
            "variant_key": "bs1_d8192_w4_silu1_bf16",
            "batch_size": 1,
            "dim": 8192,
            "width": 4,
            "has_silu": 1,
        ...
        {
            "variant_key": "bs4_d2048_w4_silu1_bf16",
            "batch_size": 4,
            "dim": 2048,
            "width": 4,
            "has_silu": 1,
        ...
        {
            "variant_key": "bs4_d4096_w4_silu1_bf16",
            "batch_size": 4,
            "dim": 4096,
            "width": 4,
            "has_silu": 1,
...
def causal_conv1d_decode(
    ...
    kernel = get_decode_kernel(
        width, batch, dim, "bfloat16", has_silu
    )
    output = kernel(
        x_kernel,
        weight_t,
