...
template <>
class EmbeddingVLMImpl<xllm::Qwen2_5_VLForEmbedding> : public EmbeddingVLM {
 public:
  EmbeddingVLMImpl(xllm::Qwen2_5_VLForEmbedding model,
