...
// --- dit debug ---
XLLM_REGISTER_HELP_SECTION(kDitDebugSection, "DIT DEBUG", "");
#undef XLLM_CURRENT_HELP_SECTION
#define XLLM_CURRENT_HELP_SECTION kDitDebugSection
...
// --- embedding type ---
XLLM_REGISTER_HELP_SECTION(kEmbeddingTypeSection, "EMBEDDING TYPE", "");
#undef XLLM_CURRENT_HELP_SECTION
#define XLLM_CURRENT_HELP_SECTION kEmbeddingTypeSection
