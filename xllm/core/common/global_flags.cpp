...
DEFINE_int64(dit_cache_end_steps,
             5,
...
// --- dit parallel config ---
XLLM_REGISTER_HELP_SECTION(kDitParallelConfigSection,
                           "DIT PARALLEL CONFIG",
                           "");
#undef XLLM_CURRENT_HELP_SECTION
#define XLLM_CURRENT_HELP_SECTION kDitParallelConfigSection

DEFINE_int64(tp_size, 1, "Tensor parallelism size.");

DEFINE_int64(sp_size, 1, "Sequence parallelism size.");

DEFINE_int64(cfg_size, 1, "Classifier-free guidance parallelism size.");

DEFINE_int64(dit_sp_communication_overlap,
             1,
             "Communication and computation overlap for sequence parallel.");

// --- dit debug config ---
XLLM_REGISTER_HELP_SECTION(kDitDebugConfigSection, "DIT DEBUG CONFIG", "");
#undef XLLM_CURRENT_HELP_SECTION
#define XLLM_CURRENT_HELP_SECTION kDitDebugConfigSection

DEFINE_bool(dit_debug_print,
            false,
            "Whether to print debug information for DiT models.");
