...
class BlockCopyImpl : public torch::nn::Module, public ATBBase {
 public:
...
class BlockCopy : public torch::nn::ModuleHolder<BlockCopyImpl> {
 public:
  using torch::nn::ModuleHolder<BlockCopyImpl>::ModuleHolder;
  using Impl __attribute__((__unused__)) = BlockCopyImpl;
