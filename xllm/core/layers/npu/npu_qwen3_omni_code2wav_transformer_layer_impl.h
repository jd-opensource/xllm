...
#include "xllm_atb_layers/models/qwen3_omni/code2wav/layer/code2wav_transformer.h"

namespace xllm {
namespace layer {

class Qwen3OmniCode2WavTransformerLayerImpl : public BaseLayer {
 public:
  explicit Qwen3OmniCode2WavTransformerLayerImpl(const ModelContext& context,
 ...
 private:
  ...
  atb_speed::qwen3_omni::Code2WavTransformerLayerParam encode_param_;
...
TORCH_MODULE(Qwen3OmniCode2WavTransformerLayer);
}  // namespace layer
}  // namespace xllm
