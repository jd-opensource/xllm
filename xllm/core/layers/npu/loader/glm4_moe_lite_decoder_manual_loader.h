...
class Glm4MoeDecoderLiteManualLoader : public BaseManualLoader {
 public:
  Glm4MoeDecoderLiteManualLoader(uint64_t weight_count,
 ...
 protected:
  ...
  void padding_qb_weight(const StateDict& state_dict,
