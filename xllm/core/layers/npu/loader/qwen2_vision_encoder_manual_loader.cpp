...
#include "qwen2_vision_encoder_manual_loader.h"
...
using namespace qwen2_vision_encoder_constants;

Qwen2VisionEncoderManualLoader::Qwen2VisionEncoderManualLoader(
...
void Qwen2VisionEncoderManualLoader::load_state_dict(
...
void Qwen2VisionEncoderManualLoader::verify_loaded_weights() const {
  for (const auto& [index, name] : WEIGHT_MAPPING) {
...
void Qwen2VisionEncoderManualLoader::merge_host_at_weights() {
...
void Qwen2VisionEncoderManualLoader::get_weights_col_packed_qkv() {
