...
#include "common/gated_delta_net.h"
#if defined(USE_MLU)
...
class Qwen35MoeDecoderLayerImpl : public torch::nn::Module {
 public:
  Qwen35MoeDecoderLayerImpl(const ModelContext& context, int32_t layer_id);
 ...
 private:
  ...
  Qwen2Attention full_attention_{nullptr};
  GatedDeltaNet linear_attention_{nullptr};
...
TORCH_MODULE(Qwen35MoeDecoderLayer);
