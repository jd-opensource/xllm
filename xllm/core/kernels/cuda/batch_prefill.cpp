...
Array<int64_t> BatchPrefillWithKVCachePlan(
  ...
  cudaError_t status =
      PrefillPlan<IdType>(float_workspace_buffer->data,
                          float_workspace_size_in_bytes,
                          int_workspace_buffer->data,
                          page_locked_int_workspace_buffer->data,
                          int_workspace_size_in_bytes,
                          plan_info,
                          static_cast<IdType*>(qo_indptr->data),
...
void BatchPrefillWithPagedKVCacheRun(TensorView float_workspace_buffer,
  ...
  DISPATCH_context(
      ...
      [&] {
        ...
        params.lse =
            maybe_lse ? static_cast<float*>(maybe_lse.value()->data) : nullptr;
        params.num_qo_heads = num_qo_heads;
