...
// #include <flashinfer/batch_decode_config.inc>
...
Array<int64_t> BatchDecodeWithPagedKVCachePlan(
    ...
    int64_t head_dim_qk,
    int64_t head_dim_vo,
    TensorView empty_q_data,
    TensorView empty_kv_data) {
  size_t float_workspace_size_in_bytes =
      float_workspace_buffer->shape[0] *
        ...
        DISPATCH_GQA_GROUP_SIZE(num_qo_heads / num_kv_heads, GROUP_SIZE, {
          auto work_estimation_func =
              BatchDecodeWithPagedKVCacheWorkEstimationDispatched<
                  ...
                  AttentionVariant,
                  Params>;
          cudaError_t status = DecodePlan<HEAD_DIM_QK,
                                          POS_ENCODING_MODE,
                                          AttentionVariant,
                                          Params>(
              ...
              plan_info,
              static_cast<IdType*>(indptr->data),
              batch_size,
              num_qo_heads,
              page_size,
              enable_cuda_graph,
  ...
  DISPATCH_context(
      ...
      [&] {
        paged_kv_t<DTypeKV, IdType> paged_kv(
            ...
            batch_size,
            kv_layout,
            static_cast<DTypeKV*>(paged_k_cache->data),
            static_cast<DTypeKV*>(paged_v_cache->data),
            kv_cache_strides,
        ...
        if (plan_info.split_kv) {
          tmp_v =
              GetPtrFromBaseOffset<DTypeO>(float_buffer, plan_info.v_offset);
        ...
        cudaError_t status =
            flashinfer::BatchDecodeWithPagedKVCacheDispatched<HEAD_DIM_QK,
                                                              POS_ENCODING_MODE,
                                                              AttentionVariant>(
                params,
                tmp_v,
