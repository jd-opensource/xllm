...
#include "scheduler/pure_chunked_scheduler.h"
...
namespace xllm {
PureChunkedScheduler::PureChunkedScheduler(Engine* engine,
                                           const Options& options)
    : ContinuousScheduler(engine, options) {}

PureChunkedScheduler::~PureChunkedScheduler() {
...
void PureChunkedScheduler::handle_prefill_requests(
...
void PureChunkedScheduler::handle_last_step_prefill_requests(
    double& latency_budget,
    double& estimate_latency,
    size_t& remaining_token_budget,
    size_t& remaining_seq_budget,
...
std::vector<Batch> PureChunkedScheduler::prepare_batch() {
  Timer timer;
