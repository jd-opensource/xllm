...
class DeviceCaptureLock {
 public:
  ...
  static DeviceCaptureLock& getInstance() {
  ...
  std::mutex& getLock(c10::DeviceIndex device_index) {
  ...
  DeviceCaptureLock(const DeviceCaptureLock&) = delete;
  DeviceCaptureLock& operator=(const DeviceCaptureLock&) = delete;
  DeviceCaptureLock(DeviceCaptureLock&&) = delete;
  DeviceCaptureLock& operator=(DeviceCaptureLock&&) = delete;
