...
size_t calculate_raw_forward_output_size(const RawForwardOutput& output) {
  ...
  size +=
      type_size<uint64_t> + output.expert_load_data.size() * type_size<int64_t>;
...
int ForwardSharedMemoryManager::raw_input_write(
...
int ForwardSharedMemoryManager::raw_output_write(
