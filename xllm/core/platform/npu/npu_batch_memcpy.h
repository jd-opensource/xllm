...
class NPUBatchMemcpy final : public BatchMemcpy {
 ...
 private:
  ...
  aclrtMemcpyBatchAttr build_h2d_attr(int32_t device_id) const;
  aclrtMemcpyBatchAttr build_d2h_attr(int32_t device_id) const;

 private:
  bool initialized_ = false;
  int32_t device_id_ = -1;
  std::optional<aclrtMemcpyBatchAttr> h2d_attr_;
  std::optional<aclrtMemcpyBatchAttr> d2h_attr_;
};
