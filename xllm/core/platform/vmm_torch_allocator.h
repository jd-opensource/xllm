...
// CUDACachingAllocator interface (CUDA, ILU, ROCm/DCU).
...
class VMMTorchAllocator final
 ...
 public:
  ...
  // ============== HIPAllocator interface (should NOT be called)
  // ==============
  ...
  void recordStream(const c10::DataPtr& /*ptr*/,
                    c10::hip::HIPStream /*stream*/) override {
    LOG(FATAL) << "VMMTorchAllocator::recordStream() called unexpectedly!";
  }
  ...
  void attachOutOfMemoryObserver(
      c10::hip::HIPCachingAllocator::OutOfMemoryObserver /*observer*/)
      override {
    LOG(FATAL) << "VMMTorchAllocator::attachOutOfMemoryObserver() called "
                  "unexpectedly!";
  }
  ...
  void attachAllocatorTraceTracker(
      c10::hip::HIPCachingAllocator::AllocatorTraceTracker /*tracker*/)
      override {
    LOG(FATAL) << "VMMTorchAllocator::attachAllocatorTraceTracker() called "
                  "unexpectedly!";
  }
  ...
  void endAllocateToPool(c10::DeviceIndex /*device*/,
                         at::hip::MempoolId_t /*mempool_id*/) override {
    LOG(FATAL) << "VMMTorchAllocator::endAllocateToPool() called unexpectedly!";
  }
  ...
  std::vector<c10::hip::HIPCachingAllocator::StreamSegmentSize>
  getExpandableSegmentSizes(c10::DeviceIndex /*device*/) override {
    LOG(FATAL) << "VMMTorchAllocator::getExpandableSegmentSizes() called "
                  "unexpectedly!";
    return {};
  ...
  c10::hip::HIPCachingAllocator::SnapshotInfo snapshot(
      at::hip::MempoolId_t /*mempool_id*/ = {0, 0}) override {
    LOG(FATAL) << "VMMTorchAllocator::snapshot() called unexpectedly!";
    return {};
  }
  ...
  void recordHistory(
      ...
      size_t /*alloc_trace_max_entries*/,
      c10::hip::HIPCachingAllocator::RecordContext /*when*/,
      bool /*clearHistory*/) override {
    LOG(FATAL) << "VMMTorchAllocator::recordHistory() called unexpectedly!";
  }
#else
  void emptyCache(c10::hip::MempoolId_t /*mempool_id*/ = {0, 0}) override {
    LOG(FATAL) << "VMMTorchAllocator::emptyCache() called unexpectedly!";
  }

  c10::hip::HIPCachingAllocator::SnapshotInfo snapshot(
      c10::hip::MempoolId_t /*mempool_id*/ = {0, 0}) override {
    LOG(FATAL) << "VMMTorchAllocator::snapshot() called unexpectedly!";
    return {};
  }
