...
* Follow the code style guide in [custom-code-style.md](.claude/skills/code-review/references/custom-code-style.md).
...
* Review the code changes for the project-specific coding style in [custom-code-style.md](.claude/skills/code-review/references/custom-code-style.md).
