...
async def async_request_mindie_openai_completions(
    request_func_input: RequestFuncInput,
    pbar: Optional[tqdm] = None,
) -> RequestFuncOutput:
    api_url = request_func_input.api_url
...
ASYNC_REQUEST_FUNCS = {
    ...
    "xllm": async_request_openai_completions,
    "lmdeploy": async_request_openai_completions,
    "trt": async_request_trt_llm,
    "gserver": async_request_gserver,
    "truss": async_request_truss,
    "mindie": async_request_mindie_openai_completions,
}
...
async def benchmark(
    ...
    # Warmup
    # TODO: add more request for warmup
...
def run_benchmark(args_: argparse.Namespace):
    ...
    elif args.backend in ["sglang-oai", "vllm", "xllm", "lmdeploy", "mindie"]:
        api_url = (
