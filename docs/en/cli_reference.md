...
| `enable_prefill_piecewise_graph` | `bool` | false | true | Whether to enable piecewise CUDA graph for prefill phase. Attention runs eagerly while other ops are captured into CUDA graphs. |  |
