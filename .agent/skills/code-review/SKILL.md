...
Read [custom-code-style.md](custom-code-style.md) for project-specific coding style.
...
**DO:**
- Apply project-specific style from [custom-code-style.md](custom-code-style.md)
