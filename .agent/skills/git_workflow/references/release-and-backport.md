...
- release branch names use `release/vX.Y.Z`
- release tags use normal semantic versions like `v0.9.0` or `v0.9.1`
- bugfix backports come from a commit already landed on `main` when possible
