...
# Allow users to run `sh third_party/dependencies.sh ...` by re-executing in Bash.
...
MEMFABRIC_TARGET_COMMIT="e4da5b358e4669abe44f1cf4d09bfb54b6d16f20"
...
usage() {
    cat <<EOF
Usage: bash third_party/dependencies.sh <dependency_name> <device> [enable_ha]
